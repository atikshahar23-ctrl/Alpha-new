...
export function mountApp(root: HTMLElement) {
  root.innerHTML = `
    <div class="app">
      ...
      <div class="chrome topL"><div class="topL-txt"><div class="wm" data-i18n="appTitle">אלפא עוזר אישי</div><div class="wm-hg">HEAVY GUARD OS</div><div class="clk" id="clock">--:--</div><div class="build-ver" id="buildVer">v438 ⚡</div></div></div>
